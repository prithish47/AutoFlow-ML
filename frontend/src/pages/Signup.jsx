            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[var(--text-primary)]">
                        Get started with Flow<span className="text-indigo-600">ML</span>
                    </h1>
                    <p className="text-sm text-[var(--text-secondary)] mt-2">
                        Create your account to start building ML pipelines
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl p-6 space-y-4 shadow-2xl">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                        />
                        <p className="text-[10px] text-[var(--text-muted)] mt-1">Min 6 characters</p>
                    </div>
                    ...
                    <div className="pt-3 border-t border-[var(--border-color)]">
                        <p className="text-[10px] text-[var(--text-muted)] text-center">
                            🎉 Start with our <span className="text-indigo-400 font-medium">Free Plan</span> — 10 nodes, 5MB datasets, 30s execution
                        </p>
                    </div>
                </form>
            </div>
