...
export default function TopBar() {
    ...
    return (
        <header className="h-16 bg-[#ffffff] border-b border-black/5 flex items-center justify-between px-6 z-50">
            ...
            <div className="flex items-center gap-1 bg-[#f8fafc] p-1 rounded-lg border border-black/5">
                {[
                    ...
                    <button
                        ...
                        className="h-8 px-4 flex items-center gap-2 rounded hover:bg-white text-[12px] font-medium text-[#64748b] hover:text-[#0f172a] transition-all disabled:opacity-30 border border-transparent hover:border-black/5 hover:shadow-sm"
                    >
                        <btn.icon size={15} />
                        <span>{btn.label}</span>
                    </button>
